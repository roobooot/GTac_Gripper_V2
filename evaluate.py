...
def evaluate (args):
  ...
  ## Build model
  model_ = network.utils.get_network(args.network, dataset_.data.num_features, eval_loader_.dataset.num_classes).to(device_)
  log.info(model_)
...
if __name__ == "__main__":
    ...
    #args_.checkpoint="C:\\Users\\Lenovo\\Desktop\\tactile-gcn-12features\\ckpts\\train-GCN_test-False-0-Aug22_23-22-36_fold4_val.pkl"
